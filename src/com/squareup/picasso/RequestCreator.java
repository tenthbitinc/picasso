...
public class RequestCreator {
    ...
    public RequestCreator resizeDimen(int targetWidthResId, int targetHeightResId,
            boolean onlyResizeDown) {
        Resources resources = picasso.context.getResources();
        int targetWidth = resources.getDimensionPixelSize(targetWidthResId);
        int targetHeight = resources.getDimensionPixelSize(targetHeightResId);
        return resize(targetWidth, targetHeight, onlyResizeDown);
    }

    /** Resize the image to the specified size in pixels. */
    public RequestCreator resize(int targetWidth, int targetHeight, boolean onlyResizeDown) {
        data.resize(targetWidth, targetHeight, onlyResizeDown);
        return this;
    }
    ...
    public void into(ImageView target, Callback callback) {
        ...
        Action action = new ImageViewAction(picasso, target, finalData, skipMemoryCache, noFade,
