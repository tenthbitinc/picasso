...
public class Picasso {
    ...
    Picasso(Context context, Dispatcher dispatcher, Cache cache, Listener listener,
        ...
        this.stats = stats;
        targetToAction = new WeakHashMap<Object, Action>();
        targetToDeferredRequestCreator = new WeakHashMap<ImageView, DeferredRequestCreator>();
    ...
    Request transformRequest(Request request) {
        ...
        if (transformed == null) {
            throw new IllegalStateException("Request transformer "
                    + requestTransformer.getClass().getCanonicalName() + " returned null for "
                    + request);
        }
        return transformed;
    }
