...
public final class Request {
    ...
    private Request(Uri uri, int resourceId, List<Transformation> transformations, int targetWidth,
            int targetHeight, boolean onlyResizeDown, boolean centerCrop, boolean centerInside,
        ...
        this.onlyResizeDown = onlyResizeDown;
    ...
    public static final class Builder {
        ...
        private boolean onlyResizeDown;
        ...
        private Builder(Request request) {
            ...
            onlyResizeDown = request.onlyResizeDown;
        ...
        public Builder resize(int targetWidth, int targetHeight, boolean onlyResizeDown) {
            if (targetWidth <= 0) {
        ...
        public Request build() {
            ...
            return new Request(uri, resourceId, transformations, targetWidth, targetHeight,
                    onlyResizeDown, centerCrop, centerInside, rotationDegrees, rotationPivotX,
                    rotationPivotY, hasRotationPivot);
        }
    }
}
